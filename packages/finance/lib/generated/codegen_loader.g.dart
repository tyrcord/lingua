...
class FinanceCodegenLoader extends AssetLoader {
  ...
  "finance": {
    ...
    "help": {
      ...
      "price_after_vat": {
        "example": "商品が税抜きで10ドルの場合、消費税率が20％であれば、消費税込みの価格は12ドルになります。値として12を入力してください。",
        "text": "付加価値税（VAT）を加算した後の商品またはサービスの総価格を指します。これは消費者が支払う小売価格です。VATは多くの国で商品やサービスの販売に適用される消費税です。"
      },
      "price_before_vat": {
    ...
    "label": {
      ...
      "duration": {
        "double": {
          "investment": "投資を倍増させるまでの期間"
        }
      },
      "duration_years": "年単位の期間",
      "earnings": "収益",
      "effective_annual_rate": "実効年率",
      "ending": {
        "balance": "最終残高",
        "principal": "最終元本"
      },
...
static const Map<String,dynamic> zh = {
  "finance": {
    ...
    "help": {
      ...
      "price_after_vat": {
        "example": "如果一种产品税前价格为10美元，并且适用20%的增值税率，那么增值税后的价格将为12美元，请输入12作为值。",
        "text": "指的是在添加增值税（VAT）后的产品或服务的总价格。这是消费者支付的零售价格。增值税是许多国家对商品和服务销唀征收的一种消费税。"
      },
      "price_before_vat": {
...
static const Map<String,dynamic> en = {
  "finance": {
    ...
    "help": {
      ...
      "price_after_vat": {
        "example": "If a product costs \u002410 before taxes and is subject to a VAT rate of 20%, the price after VAT would be \u002412, enter 12 as the value.",
        "text": "Refers to the total price of a product or service after the addition of the value-added tax (VAT). This is the retail price that consumers pay. VAT is a tax on consumption that is applied to the sale of goods and services in many countries."
      },
      "price_before_vat": {
    ...
    "label": {
      ...
      "duration": {
        "double": {
          "investment": "Duration to double investment"
        }
      },
